...
//------------------21.02.2023-------------------
// Homework ------- EXCEPTIONS--------------------
//Take last homework and handle as many exceptions as possible
//------------------------------------------------
// до попередньої домашки було зауваження: found this part repeated below, so it should be a method
...
// Виправлю в цій домашці.
// ------Рішення - додав функцію int ReadNumberFromConsole(int maxnum)
