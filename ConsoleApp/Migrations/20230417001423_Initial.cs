        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Desription = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Histiries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Histiries_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Histiries_Customers_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Histiries_BookId",
                table: "Histiries",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_Histiries_CustomerId",
                table: "Histiries",
                column: "CustomerId");
        }
