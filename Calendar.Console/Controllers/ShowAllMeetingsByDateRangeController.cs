...
{
    internal class ShowAllMeetingsByDateRangeController : IController
    {
        private readonly Context _context;
        private readonly DateTime _startRange;
        private readonly DateTime _endRange;

        public ShowAllMeetingsByDateRangeController(Context context, DateTime startRange, DateTime endRange)
        {
            _context = context;
        ...
        public void Show()
        {
            ...
            System.Collections.Generic.IEnumerable<Meeting> meetings = _context.Service.GetAllMeetings();
